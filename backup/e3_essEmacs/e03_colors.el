...
(set-face-foreground 'font-lock-keyword-face         "Cyan")     ;DONE org3 if,for,function,lambda ;Cyan,Purple,Yellow; "MediumBlue"(ess)
(set-face-foreground 'font-lock-comment-face         "Grey80")      ;DONE org4 #  % "Firebrick"(ess) Sienna DarkGrey Grey80,SeaGreen,palegreen;  
...
(set-face-foreground 'font-lock-constant-face        "Magenta")        ;DONE org6 require <- + - ==;Brown,;Magenta(ess),"VioletRed"
